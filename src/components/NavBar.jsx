    ...
    <nav className="bg-white shadow-md w-full z-10">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className="hidden md:flex space-x-4">
          {user ? (
            <>
              <span className="pt-2 text-gray-700 font-medium">Hello, {userData?.name || user.email?.split("@")[0] || "User"}</span>
      ...
      {isOpen && (
        <ul className="md:hidden bg-white shadow-md flex flex-col items-center space-y-4 py-4">
          ...
          {user ? (
            <>
              <span className="text-gray-700 font-medium">Hello, {userData?.name || user.email?.split("@")[0] || "User"}</span>
